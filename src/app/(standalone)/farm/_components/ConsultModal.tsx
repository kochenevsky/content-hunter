// src/app/(standalone)/farm/_components/ConsultModal.tsx
'use client';
  ...
  useEffect(() => {
    const checkTelegram = async () => {
      try {
        ...
        await fetch('https://t.me/', { mode: 'no-cors', signal: controller.signal });
        ...
        {isSubmitted ? (
          ...
          <>
            ...
            <h2 className="modal-title">
              Получить<br /><span>консультацию</span>
            </h2>
