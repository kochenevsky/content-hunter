...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Нет. Мы берем ролики, которые у вас уже есть. Из каждого делаем 20–30 уникальных версий. Они подходят для запуска.',
  },
  {
    q: 'Как быстро будет результат?',
    a: 'Первые публикации — через 10 дней после старта (прогрев аккаунтов). Контент-маркетинг работает накопительно: каждый месяц лучше предыдущего.',
  },
  {
