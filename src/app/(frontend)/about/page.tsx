...
const mockTeam = [
  {
    ...
    bio: 'Эксперт по контент-маркетингу с 8-летним опытом. Запустил 50+ контент-заводов в разных нишах. Спикер конференций по digital-маркетингу.',
    telegram: '@kirillpopov',
    order: 1,
  },
  {
    id: '2',
    ...
    bio: 'Руководит производством контента. 6 лет в видеопродакшене. Организует съёмки и контролирует качество 500+ роликов в месяц.',
    telegram: '@anna_smr',
    order: 2,
  },
  {
    ...
    bio: 'Отвечает за инфраструктуру и дистрибуцию. Эксперт по алгоритмам социальных сетей. Управляет сетью из 500+ аккаунтов.',
    telegram: '@dmitry_k',
    order: 3,
  },
  {
    ...
    bio: 'Разрабатывает контент-стратегии для клиентов. 5 лет в SMM и performance-маркетинге. Специализация — e-commerce и EdTech.',
    telegram: '@maria_ivn',
    order: 4,
  },
]
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-neutral-400">
              Content Hunter — это команда экспертов по контент-заводам. 
              Мы строим системы массовой дистрибуции контента, которые 
              гарантируют охваты и лиды.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-neutral-400 mb-8">
                Работаем с клиентами по всему миру. Создаём контент на 
                любых языках, адаптируем под локальные платформы.
              </p>
